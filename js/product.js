...
async function fetchProduct(){
    ...
    document.getElementById("headdd").innerHTML= `<h4 style="color: rgb(123, 121, 121);margin-bottom: 15px;">${product.category}</h4>
           ...
           <div style="word-spacing: 10px;margin-bottom: 10px;">
            ...
            <span style="color:  rgb(41, 158, 26);font-weight: bolder; letter-spacing: 2px; font-size:39px;">${product.discountPercentage}%OFF</span>
           </div>
        ...
        <span class="last-btn">
            <button class="last-btn1" onclick="addToCart()">ADD TO CART</button>
             <a href="/pages/buy.html"><button class="last-btn2" onclick="purchase()">BUY NOW</button> </a>
        </span>`
        str=``
